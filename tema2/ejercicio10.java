...
public class ejercicio10 {
    ...
    public static void main(String[] args) {
        ...
        String[] frase = texto.split("\\a");
        int numeroFrases = frase.length;
        double random = Math.random() * 10;
        
        System.out.println("Obtenemos " + numeroFrases + " frases");

        //depende de la frase que quiera
        
        System.out.println("Frase Primera " + frase[0]);
        System.out.println("Frase última : " + frase[frase.length-1]);
